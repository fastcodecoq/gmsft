    ...
    var gomo = function(){    	    
       ...
       a.portfolio = {
            "web" : [  
                    ...
                    { name : "Castleway Productions" , pic : "castleway.jpg"},
                    { name : "Chocolates la Torre" , pic : "choco.jpg"},
                    { name : "Fifa Comidas Rapidas" , pic : "fifa.jpg"},
                  ...
                  { name : "Hotelea" , pic : "hotelea.jpg"},                    
                    ...
                    { name : "Inmueble a la venta" , pic : "inmueble.jpg"},
     	...
     	a.title = {
    		"es" : "Diseño de paginas web y software en Colombia",
    		"en" : "Web design & Software in Colombia",
    		"fr" : "Web design & Software in Colombia"
     	}
        ...
        a.isMobile = /android|ios|firefoxos|phone|mobile|blackberry|tyzen/g.test(userAgent);
       ...
       window.loadPortafolio = function (section){


            var section = section || "web";            
            var markup = '<div class="item column">'
           ...
           var content = "";
            ...
            for(x in portfolio[section])
                 content += markup.replace(/\{\{src\}\}/g, "assets/portfolio/" + section + "/" + portfolio[section][x].pic)
                                  .replace(/\{\{name\}\}/g, portfolio[section][x].name);             
       ...
       function vibrate(){
        ...
        function onEvents(){
            ...
            $("[data-vibrate]").live("click", vibrate);
